...
const Header = () => {
  ...
  const logoutMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setProfile(null)
      queryClient.removeQueries({ queryKey: ['purchases', { status: purchaseStatus.cartIn }] })
    }
  })
    ...
    >
      <div className='wrap-content'>
        ...
        <div className='flex flex-wrap justify-between items-center pt-4'>
          <Link to={path.home} className='w-[202px] shrink-0 pr-[60px]' title='Trang chủ'>
            <svg viewBox='0 0 192 65' className='fill-white'>
              <g>
                ...
                {purchases ? (
                  <div className='p-2'>
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      <Link
                        to={path.cart}
                        className='rounded-sm text-white bg-[#fb5533] p-2 capitalize hover:opacity-[90%]'
                      >
                        Xem giỏ hàng
                      </Link>
                    </div>
